<?php /* Template Name: Precious Beard */ 
...
<main>
    ...
    if(have_rows('services_promotion_points') || !empty($services_promotion_image)) { ?>
        <section class="service-info pt-5 py-sm-4">
            <div class="container">
    ...
    if(!empty($services_cta_main_title)) { ?>
        <section class="service-cta">
            ...
            if(!empty($services_cta_button)) { ?>
                <a href="<?php echo $services_cta_button['url']; ?>" class="app-btn mx-auto">
