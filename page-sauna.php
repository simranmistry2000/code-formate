...
<main>
    ...
    $services_product_image = get_field('services_product_image');
    if(have_rows('services_product_content') || !empty($services_product_image)) { ?>
        <section class="sauna-product">
            <div class="container">
                <div class="row gy-4 align-items-center justify-content-center">
                    <div class="col-sm-6" data-aos="fade-right" data-aos-duration="1000">
                        <div class="sauna-img">
                            <img src="<?php echo $services_product_image; ?>" class="sauna-pro" alt="">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/shadow.png" class="shadow-img" alt="">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <ul class="sauna-list">
                            <?php 
                            while( have_rows('services_product_content') ) { the_row();
                                $services_product_content_text = get_sub_field('services_product_content_text'); 
                                if(!empty($services_product_content_text)) {?>
                                    <li data-aos="fade-left" data-aos-delay="<?php echo get_row_index(); ?>00"><?php echo $services_product_content_text; ?></li><?php 
                                }
                            }
                            ?>
                        </ul>
    ...
    $services_information_image = get_field('services_information_image');
    if(have_rows('services_information_content') || !empty($services_information_image)) {?>
        <section class="service-info mt-4">
            <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-6 order-1 order-lg-0">
                            <div class="service-info-content">
                                <div class="service-info-item">
                                    <?php 
                                    while( have_rows('services_information_content') ) { the_row();
                                        $services_information_content_list = get_sub_field('services_information_content_list'); 
                                        if(!empty($services_information_content_list)) { ?>
                                            <p class="content-copy"><?php echo $services_information_content_list; ?></p><?php 
                                        }
                                    }
                                    ?>
                                </div>
                        ...
                        <div class="col-lg-6 order-0 order-lg-1">
                            <div class="service-info-img">
                                <img src="<?php echo $services_information_image; ?>" alt="">
                            </div>
                        </div>
                    </div>
                </div>
