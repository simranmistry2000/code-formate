...
<main>
    ...
    if(have_rows('services_promotion_points') || !empty($services_promotion_image)) { ?>
        <section class="service-promo">
            <div class="container">
                <div class="service-promo-container">
                    <div class="glu-promo-content" data-aos="fade-right" data-aos-duration="1000">
                        <h2 class="text-white"><?php echo $services_promotion_main_title; ?></h2>
                        <ul class="text-white fw-lighter mt-2 mt-sm-3 list-unstyled checked">
                            <?php 
                    ...
                    <div class="qr6-promo-img timer" data-aos="fade-left" data-aos-duration="1000">
