<?php /* Template Name: Chemical Peel */ 
            ...
            <div class="container">
                ...
                <div class="row g-3 g-xl-4 mt-4">
                    ...
                    while( have_rows('services_all_signature_solutions') ) { the_row(); 
                        ...
                        $services_all_signature_solutions_feature = get_sub_field('services_all_signature_solutions_feature');
                        $services_all_signature_solutions_sessions = get_sub_field('services_all_signature_solutions_sessions');
                                ...
                                <div class="service-items-card">
                                    ...
                                    <div class="service-items-content">
                                        ...
                                        <ul class="service-items-features p-0 mb-0">
                                            <li class="sif-item">
                                                <p>Feature:</p> <span class="item-badge-outline"><?php echo $services_all_signature_solutions_feature; ?></span>
                                            </li>
                                            <li class="sif-item">
                                            ...
                                            <li class="sif-item">
                                                <p>Sessions:</p> <span class="item-badge-outline"><?php echo $services_all_signature_solutions_sessions; ?></span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
