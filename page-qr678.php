...
<main>
    ...
    $qr67_sevices_all_infos_main_title = get_field('qr67_sevices_all_infos_main_title');        
    if(have_rows('qr67_sevices_all_infos')) { ?>
        <section class="info-table">
            <div class="container">
                <div class="section-title text-center">
                    <h2><?php echo $qr67_sevices_all_infos_main_title; ?></h2>
                </div>
    ...
    $qr67_service_main_title = get_field('qr67_service_main_title');
    $qr67_service_sub_title = get_field('qr67_service_sub_title');
    $qr67_service_background_image = get_field('qr67_service_background_image');
    if(have_rows('qr67_service_all_services')) { ?>
        <section class="service-static qr6" style="background-image: url('<?php echo $qr67_service_background_image; ?>'); ">
            <div class="container">
                <div class="section-title text-center mb-3 mb-sm-4" data-aos="fade-up">
                    <h2 class="text-white"><?php echo $qr67_service_main_title; ?></h2>
                    <p class="text-white"><?php echo $qr67_service_sub_title; ?></p>
                </div>

                <div class="service-static-wrapper d-flex justify-content-center gap-3 gap-lg-4 flex-wrap">
                    <?php 
                    while( have_rows('qr67_service_all_services') ) { the_row();
                        $qr67_service_all_services_percentage = get_sub_field('qr67_service_all_services_percentage');
                        $qr67_service_all_services_text = get_sub_field('qr67_service_all_services_text'); 
                        if(!empty($qr67_service_all_services_text) && !empty($qr67_service_all_services_percentage)) { ?>
                            <div class="service-static-card" data-aos="zoom-in" data-aos-delay="<?php echo get_row_index(); ?>00">
                                <div class="ss-score"><?php echo $qr67_service_all_services_percentage; ?></div>
                                <p><?php echo $qr67_service_all_services_text; ?></p>
                            </div><?php 
                        }
                    }
                    ?>                    
    ...
    $services_qr67_main_title = get_field('services_qr67_main_title');
    $services_qr67_content = get_field('services_qr67_content');
    $services_qr67_image = get_field('services_qr67_image');
    if(have_rows('services_qr67_all_points') || !empty($services_qr67_image) || !empty($services_qr67_main_title) || !empty($services_qr67_content)) { ?>
        <section class="service-promo">
            <div class="container">
                <div class="service-promo-container">
                    <div class="qr6-promo-content">
                        <h2 class="text-white"><?php echo $services_qr67_main_title; ?></h2>
                        <p class="text-white fw-lighter mt-2 mt-sm-3">
                           <?php echo $services_qr67_content; ?>
                        </p>
                    </div>
                    <div class="qr6-promo-img">
                        <img src="<?php echo $services_qr67_image; ?>" alt="">
                    </div>
                    <ul class="qr6-promo-points">
                       <?php 
                        while( have_rows('services_qr67_all_points') ) { the_row();
                            $services_qr67_all_points_list = get_sub_field('services_qr67_all_points_list'); 
                            if(!empty($services_qr67_all_points_list)) {?>
                                <li class="<?php echo (get_row_index() == 4) ? 'mb-0' : ''; ?>"><span><?php echo get_row_index(); ?></span> <?php echo $services_qr67_all_points_list; ?></li><?php 
                            }
                        }
                        ?>                        
                    </ul>
