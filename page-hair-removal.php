<?php /* Template Name: Hair Removal */ 
...
<main>  
    ...
    $services_info_main_title = get_field('services_info_main_title'); 
    $services_info_images = get_field('services_info_images'); 
    if(have_rows('services_info_all_content') || !empty($services_info_images)) { ?>
                    ...
                    <div class="row">
                        <div class="col-lg-6 order-1 order-lg-0">
                            <div class="service-info-content">
                                <strong class="content-title"><?php echo $services_info_main_title; ?></strong>
                                <?php 
                                while( have_rows('services_info_all_content') ) { the_row(); 
                                    $services_info_all_content_points = get_sub_field('services_info_all_content_points'); 
                                    if(!empty($services_info_all_content_points)) { ?>
                                        <p class="content-copy">
                                            <?php echo $services_info_all_content_points; ?>
                                        </p><?php 
                                    }
                                }
                                ?>                                
                        ...
                        <div class="col-lg-6 order-0 order-lg-1">
                            <div class="service-info-img">
                                <img src="<?php echo $services_info_images; ?>" alt="">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    $hair_removal_info_laser_side_left_image = get_field('hair_removal_info_laser_side_left_image'); 
    $hair_removal_info_laser_side_right_image = get_field('hair_removal_info_laser_side_right_image'); 
    if(have_rows('hair_removal_info_laser_side_left_points') || have_rows('hair_removal_info_laser_side_right_points')) { ?>
        <section class="razor-laser">
            <div class="container-fluid p-0">
                <div class="lvr-container d-flex flex-column flex-lg-row align-items-center justify-content-between">

                    <!-- Laser Side (Left) -->
                    <div class="lvr-items lvr-left">
                        <?php                         
                        if(!empty($hair_removal_info_laser_side_left_image)) { ?>
                        <div class="lvr-img">
                            <img src="<?php echo $hair_removal_info_laser_side_left_image; ?>" alt="">
                        </div><?php 
                        }
                        while( have_rows('hair_removal_info_laser_side_left_points') ) { the_row(); 
                            $hair_removal_info_laser_side_left_points_text = get_sub_field('hair_removal_info_laser_side_left_points_text'); 
                            if(!empty($hair_removal_info_laser_side_left_points_text)) { ?>
                                <div class="lvr-letf-item item-<?php echo get_row_index(); ?> justify-content-end <?php echo (get_row_index() === 1) ? 'justify-content-sm-start' : ''; ?>">
                                <?php echo $hair_removal_info_laser_side_left_points_text; ?>
                                </div><?php 
                            }
                        }
                        ?>
                    ...
                    <!-- Razor Side (Right) -->
                    <div class="lvr-items lvr-right">
                        <?php                         
                        if(!empty($hair_removal_info_laser_side_right_image)) { ?>
                        <div class="lvr-img">
                            <img src="<?php echo $hair_removal_info_laser_side_right_image; ?>" alt="">
                        </div><?php 
                        }
                        while( have_rows('hair_removal_info_laser_side_right_points') ) { the_row(); 
                            $hair_removal_info_laser_side_right_points_text = get_sub_field('hair_removal_info_laser_side_right_points_text'); 
                            if(!empty($hair_removal_info_laser_side_right_points_text)) { ?>
                                <div class="lvr-right-item item-<?php echo get_row_index(); ?> <?php echo (get_row_index() === 1) ?  'text-start text-sm-end justify-content-start justify-content-sm-end' : 'text-end'; ?>">
                                <?php echo $hair_removal_info_laser_side_right_points_text; ?>
                                </div><?php 
                            }
                        }
                        ?>
    ...
    $hair_removal_service_sub_title = get_field('hair_removal_service_sub_title'); 
    if(have_rows('hair_removal_service_all_services')) { ?>
        <section class="service-static lesar">
            <div class="container">
                <div class="section-title text-center mb-3 mb-sm-4" data-aos="fade-up">
                    <h2 class="text-white"><?php echo $hair_removal_service_main_title; ?></h2>
                    <p class="text-white"><?php echo $hair_removal_service_sub_title; ?></p>
                </div>
                ...
                <div class="service-static-wrapper d-flex align-items-center justify-content-center gap-3 gap-lg-4 flex-wrap">
                    ...
                    while( have_rows('hair_removal_service_all_services') ) { the_row(); 
                        ...
                        if(!empty($hair_removal_service_all_services_percentage) && !empty($hair_removal_service_all_services_text)) { ?>
                            <div class="service-static-card" data-aos="zoom-in" data-aos-delay="<?php echo get_row_index(); ?>00">
    ...
    if(have_rows('hair_removal_all_dos_donts')) { ?>
        <section class="info-table">
            <div class="container">
                <div class="info-table-wrapper dos-dont">
                    <?php                     
                    while( have_rows('hair_removal_all_dos_donts') ) { the_row(); 
                        $points = get_row_index(); 
                        $hair_removal_all_dos_donts_icon = get_sub_field('hair_removal_all_dos_donts_icon'); 
                        $hair_removal_all_dos_donts_main_title = get_sub_field('hair_removal_all_dos_donts_main_title'); 
                        if(!empty($hair_removal_all_dos_donts_icon) || !empty($hair_removal_all_dos_donts_main_title) || have_rows('hair_removal_all_dos_donts_all_points')) {  ?>
                            <div class="info-table-box-wrapper">
                                <div class="info-table-box">
                                    <div class="info-table-header d-flex gap-2 align-items-center justify-content-center">
                                        <img src="<?php echo $hair_removal_all_dos_donts_icon; ?>" alt="icon">
                                        <p class="text-center mt-2"> <?php echo $hair_removal_all_dos_donts_main_title; ?></p>
                                    </div>
                                    <?php 
                                    while( have_rows('hair_removal_all_dos_donts_all_points') ) { the_row(); 
                                        $hair_removal_all_dos_donts_all_points_text = get_sub_field('hair_removal_all_dos_donts_all_points_text'); 
                                        if(!empty($hair_removal_all_dos_donts_all_points_text)) { ?>
                                            <div class="info-table-item">
                                                <p class="points <?php echo ($points == 1) ? 'do' : 'dont'; ?>"><?php echo $hair_removal_all_dos_donts_all_points_text; ?>
                                                </p>
                                            </div><?php 
                                        }
                                    }
    ...
    if(have_rows('real_all_transfermations')) { ?>
        <section class="result pt-0 pt-sm-3">
            <div class="container">
